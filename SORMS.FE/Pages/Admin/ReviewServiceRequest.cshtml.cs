...
namespace SORMS.FE.Pages.Admin
{
    public class ReviewServiceRequestModel : PageModel
    {
        ...
        public new Staff.ServiceRequestDto? Request { get; set; }
        ...
        public async Task<IActionResult> OnGetAsync(int requestId)
        {
            ...
            try
            {
                ...
                {
                    Request = JsonSerializer.Deserialize<Staff.ServiceRequestDto>(content, new JsonSerializerOptions
                    {
                    ...
                    if (Request == null)
                    {
                        ...
                        return RedirectToPage("/Admin/ServiceRequestManagement");
                    }
